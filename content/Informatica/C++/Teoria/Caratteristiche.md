...
Restituisce `true` se il vettore Ã¨ vuoto.
...
Inserisce uno o piÃ¹ elementi in una posizione specificata.
...
Costruisce un elemento direttamente in fondo al vettore (piÃ¹ efficiente di `push_back` per oggetti complessi).
